...
public class RemoveController extends HttpServlet {
    ...
    private static final Logger logger = LogManager.getLogger(RemoveController.class);
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                if (cart != null) {
                    if (cart.getCart().containsKey(id)) {
                        ...
                        request.setAttribute("MESSAGE", "This product is not in your cart!");
                    }
                } else {
            ...
            logger.error("Error at RemoveController: " + e.toString());
        } finally {
